...
var msg = "<table style='margin-left:auto; margin-right:auto; border:3px solid gold; width:40%; background-color:gray; text-align:center; color:white; font-size:24px'><td>Menu:</td>";
 ...
 msg += "<td id = 'button3'><button onClick='myproduct = product3;execButton453(myproduct)'>Product3</button>";
 msg  += "</td></tr></table>";
 return(msg);
}
...
var imgurl797 = "http://college1.com/images/" + myproduct.id + ".gif";
